...
public class QuerySocialSecServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		logger.info("query social security servlet start ...");
		...
		try {
		   ...
		   str = (String)call.invoke(new Object[]{gh,s_year,timestep});
			...
			logger.error("When calling query social security interface, exception is thrown");
		...
		try {
			...
			logger.error("When calling query social security AES_256 decrypt interface, exception is thrown");
	    	     ...
	    	     while (iter1.hasNext()) {
	             	...
	             	while (iters.hasNext()) {
						...
						html.append("<html>")
			                ...
			                .append("</head>")
			                .append("<body>")
							.append("<div align=\"center\" id=\"div3\" style=\"position:relative;margin-top:50px;display: block\" >")
							.append("<div id=\"SbTitle\" style=\"position:relative;margin-bottom:20px;\"><font size=\"5\">")
							.append("Y"+(Integer.parseInt(s_year)+1)+" Social Insurance Base Confirm</font></div>")
							.append("<table id=\"tbSb\" style=\"width:100%;\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" class=\"thin\">")
							.append("<tr><td>EmployeeName</td><td>DeptName</td><td>ID Code</td><td id=\"SbTitleAVIncomeEg\">")
							.append("Y"+s_year+"_Average Monthly Salary")
							.append("</td><td id=\"SbTitlebaseEg\">")
							.append("Y"+(Integer.parseInt(s_year)+1)+"_Social Insurance Base")
							.append("</td><td>Confirm by Employee</td></tr>")
							.append("<tr><td>姓名</td><td>部门</td><td>身份证号码</td><td id=\"SbTitleAVIncomeCh\">")
							.append(s_year+"年月平均收入")
							.append("</td><td id=\"SbTitlebaseCh\">")
							.append((Integer.parseInt(s_year)+1)+"年社公积金数")
		...
		logger.error("When calling query social security xml analysis interface, exception is thrown");
		logger.error("exception is ...."+ExceptionUtils.getStackTrace(e));
		Map mxmap = new HashMap();
		...
		logger.info("query social security servlet end ...");
	}
}