...
public class SocialSecurityController extends AbstractController{
	...
	{
		logger.info("Social Security page query start ...");
		...
		if (resultMap != null && (!resultMap.isEmpty())) {
			...
			String subname = userDao.getSubcompanyname(bucode, alcode);
		...
		ModelAndView model = new ModelAndView("carrefour_socialSecurity");
		...
		logger.info("Social Security page query end ...");
		return model;
	}
}